...
export class SeedAssets1767610200000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        // 1. Clear existing assets to prevent duplicate errors
        await queryRunner.query(`DELETE FROM "assets"`);

        // 2. Insert Assets with Deposit Addresses
        await queryRunner.query(`
            ...
            -- XUU (Gold - ERC20 usually, though deposits disabled)
            ('f121855e-0493-4100-9118-c5157152066c', 'XUU', 'Gold', 18, 'commodity', false, false, true, 'https://assets.coingecko.com/coins/images/9519/small/tether-gold.png', '0x71C7656EC7ab88b098defB751B7401B5f6d8976F');
        `);
    }
